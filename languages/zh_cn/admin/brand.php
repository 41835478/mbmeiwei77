...
$_LANG['drop_brand_banner'] = '删除横幅';
$_LANG['confirm_drop_logo'] = '你确认要删除该图标吗？';
$_LANG['confirm_drop_banner'] = '你确认要删除该横幅吗？';
$_LANG['drop_brand_logo_success'] = '删除品牌logo成功';
$_LANG['drop_brand_banner_success'] = '删除品牌banner成功';
...
$_LANG['up_brandbanner'] = '请上传宽度为1172px的图片，做为品牌的banner！';
$_LANG['warn_brandlogo'] = '你已经上传过图片。再次上传时将覆盖原图片！';
$_LANG['warn_brandbanner'] = '你已经上传过图片。再次上传时将覆盖原图片！';
