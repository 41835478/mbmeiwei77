 ...
 * ============================================================================
 * $Author: liubo $
 * $Id: quickBuy.php 17217 2011-01-19 06:29:08Z liubo $
*/
...
if (empty($_GET['encode']))
{
    ...
    header("Location: quickBuy.php?encode=$string\n");
...
else
{
    ...
    /* 分页 */
    $url_format = "quickBuy.php?category=$category&amp;keywords=" . urlencode(stripslashes($_REQUEST['keywords'])) . "&amp;brand=" . $_REQUEST['brand']."&amp;action=".$action."&amp;goods_type=" . $_REQUEST['goods_type'] . "&amp;sc_ds=" . $_REQUEST['sc_ds'];
    if (!empty($intromode))
    {
